...
class boxinPost extends StatefulWidget {
  const boxinPost({super.key});

  @override
  State<boxinPost> createState() => _boxinPostState();
}

class _boxinPostState extends State<boxinPost> {
